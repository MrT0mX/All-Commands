...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  let getWanted = (
    await axios.get(encodeURI(`https://imgur.com/EiDVzYR.png`), {
      responseType: "arraybuffer",
    })
  ).data;
  ...
  ctx.drawImage(baseAva, 135, 135, 140, 140);
  ctx.font = "35px Manrope";
  ctx.fillStyle = "#ffff";
  ctx.textAlign = "center";
  fontSize = 40;
  ctx.fillText(text1, 450, 170);
  ctx.font = "35px Manrope";
  ctx.fillStyle = "#ffff";
  ctx.textAlign = "center";
  fontSize = 20;
  ctx.fillText(text2, 450, 220);
  ctx.font = "35px Manrope";
  ctx.fillStyle = "#ffff";
  ctx.textAlign = "center";
  fontSize = 20;
  ctx.fillText(text3, 450, 270);
  ctx.beginPath();
