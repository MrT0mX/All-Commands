...
}) =>
{
  ...
  {
    axios.get(`https://cakrayp.herokuapp.com/api/textmaker/textprome/create?text=${encodeURIComponent(juswa)}&url=https://textpro.me/create-a-transformer-text-effect-online-1035.html&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
