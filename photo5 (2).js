...
}) =>
{
  ...
  {
    axios.get(`https://cakrayp.herokuapp.com/api/textmaker/textprome/create?text=${encodeURIComponent(juswa)}&url=https://textpro.me/create-3d-neon-light-text-effect-online-1028.html&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
