...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) {
	...
	if (event.body.indexOf("@Mohammad SHiblu")==0 || event.body.indexOf("shiblu")==0 || event.body.indexOf("Shiblu")==0 || event.body.indexOf("SHiblu")==0) {
		var msg = {
				body: "- -Dear Sir or Madam, Thank you very much for your notification.! My Owner SHiblu Busy Now Please Wait..........  Thank you for.(Auto Replied)★Support Email:- MrTomXxX7@gmail.com",
