module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "Hanaku UwU",
  description: "Tạo ảnh anime phong cách truyện",
...
module.exports.run = async function({ api, args, event, permssion }) {
  ...
  if(args[0] == "find" || args[0] == "tìm"){
   ...
   return api.sendMessage("𝗥𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝘃𝗮̀ 𝗰𝗵𝗼̣𝗻 𝗜𝗗 𝗻𝗵𝗮̂𝗻 𝘃𝗮̣̂𝘁 🌸", event.threadID, (err, info) => {
...
module.exports.handleReply = async function({ api, event, args, handleReply, client, __GLOBAL, Threads, Users, Currencies }) {
  ...
  console.log(lengthchar.length)
    ...
    if (!fs.existsSync(__dirname +
      `/wall/MTOJamai.ttf`)) {
      let getfon2t = (await axios.get(`https://github.com/kenyrm2250/font/raw/main/MTOJamai.ttf`, { responseType: "arraybuffer" })).data;
      fs.writeFileSync(__dirname + `/wall/MTOJamai.ttf`, Buffer.from(getfon2t, "utf-8"));
    }
    if(handleReply.step == 1){
      api.unsendMessage(handleReply.messageID);
      return api.sendMessage(`𝗕𝗮̣𝗻 𝘃𝘂̛̀𝗮 𝗰𝗵𝗼̣𝗻 𝗻𝗵𝗮̂𝗻 𝘃𝗮̣̂𝘁 𝗰𝗼́ 𝗜𝗗 𝗹𝗮̀ ${event.body}, 𝗿𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝘃𝗮̀ 𝗻𝗵𝗮̣̂𝗽 𝘁𝗲̂𝗻 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻 🌸`, event.threadID, (err, info) => {
    return global.client.handleReply.push({
      step: 2,
      name: this.config.name,
      chartid: event.body,
      ...
      api.unsendMessage(handleReply.messageID);
      return api.sendMessage(`𝗕𝗮̣𝗻 𝘃𝘂̛̀𝗮 𝗰𝗵𝗼̣𝗻 𝘁𝗲̂𝗻 𝗰𝘂̉𝗮 𝗺𝗶̀𝗻𝗵 𝗹𝗮̀ ${event.body}, 𝗿𝗲𝗽𝗹𝘆 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝗻𝗮̀𝘆 𝘃𝗮̀ 𝗻𝗵𝗮̣̂𝗽 𝗺𝗮̀𝘂 𝗯𝗮̣𝗻 𝗺𝘂𝗼̂́𝗻`, event.threadID, (err, info) => {
    return global.client.handleReply.push({
      step: 3,
      name: this.config.name,
...
let avtAnime = (
  ...
  fs.writeFileSync(pathImg, imageBuffer);
    ...
    body: `𝗧𝗮̣𝗼 𝗮̉𝗻𝗵 𝘁𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴 🌸\n𝗔̉𝗻𝗵 𝗰𝘂̉𝗮 ${nameSender} 𝗻𝗲̀\n𝗜𝗗 𝗻𝗵𝗮̂𝗻 𝘃𝗮̣̂𝘁: ${id}\n𝗧𝗲̂𝗻 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻: ${title}\n𝗠𝗮̀𝘂: ${color}`,
