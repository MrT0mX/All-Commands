...
const tt = (yesterDay, toDay, time) => new Promise((resolve) => {
	if(yesterDay == 0) resolve("No stats yet");
	if(toDay == 0) resolve("No stats yet");
...
𝒐̂̉𝒏𝒈 𝒔𝒐̂́ 𝒕𝒊𝒏 𝒏𝒉𝒂̆́𝒏 𝒕𝒓𝒐𝒏𝒈 𝒕𝒖𝒂̂̀𝒏: ${weekDay}`, threadID, messageID);
	}
}
