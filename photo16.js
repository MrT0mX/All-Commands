...
}) =>
{
  ...
  {
    axios.get(`https://cakrayp.herokuapp.com/api/textmaker/textprome/create?text=${encodeURIComponent(juswa)}&url=https://textpro.me/create-a-christmas-holiday-snow-text-effect-1007.html&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
