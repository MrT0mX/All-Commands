...
module.exports.handleEvent = async ({
	...
	["bot bsdk", "bxdk bot", "bot madharchod", "madharchod bot", "bot mc", "mc bot", "Bot mc", "Bot Mc", "bot teri pen nu", "bot tmkc", "bot gandu", "Bot lun pe", "tom lol", "bot bkl", "bot mkl", "bot gandu", "tom bc", "tom chutiya", "bot chutiya", "bot randi k", "clap bot", "bot ncc", "bot oc", "bot óc", "tom tmkc", "tom gandu", "bot tiki", "ratul madharchod", "lol bot", "loz bot", "lồn bot", "ratul bahenchod", "bot lon", "bot cac", "bot nhu lon", "bot như cc", "bot như bìu", "Bot sida", "bot sida", "bot fake", "Bảo ngu", "bot shoppee", "bad bots", "bot bxdk"].forEach((a => {
	...
	event: o,
	api: t
}) => t.sendMessage("( \\_/)                                                                            ( •_•)                                                                            // >🧠                                                            Give me your brain and put it in your head.\nDo you know if it's the Noprefix command??", o.threadID);our brain and put it in your head.\nDo you know if it's the Noprefix command??", o.threadID);threadID);