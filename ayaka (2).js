...
var min = Math.floor(Math.random() * 2);
  ...
  var money = data.money
   ...
   var callback = () => api.sendMessage({body:`Ayaka's Photo\nNumber of Photos: ${link.length}\n-100 dollar !`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"), event.messageID);              api.setMessageReaction("✅", event.messageID, (err) => {}, true);
