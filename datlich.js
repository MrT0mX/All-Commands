...
module.exports.config = {
	...
	credits: "Diluc", // Công nhận module sở hữu là ai
	description: "Đặt lịch nhắc hẹn trong box", // Thông tin chi tiết về lệnh
...
module.exports.run = async function ({ api, event, args, Users }) {
	...
	msg = `🌸 𝗧𝗮̣𝗼 𝗹𝗶̣𝗰𝗵 𝗻𝗵𝗮̆́𝗰 𝗵𝗲̣𝗻 𝘁𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴\n📌 𝗡𝗼̣̂𝗶 𝗱𝘂𝗻𝗴: ${args[0]}\n⏰ 𝗧𝗵𝗼̛̀𝗶 𝗴𝗶𝗮𝗻: ${date}${(args[2]) ? `\n💬 𝗧𝗵𝗮𝘆 𝘁𝗲̂𝗻 𝗻𝗵𝗼́𝗺 𝘁𝗵𝗮̀𝗻𝗵: ${args[2]}` : ""}`;
