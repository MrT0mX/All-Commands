...
}) =>
{
  ...
  {
    axios.get(`https://cakrayp.herokuapp.com/api/textmaker/textprome/create?text=${encodeURIComponent(juswa)}&url=https://textpro.me/decorate-green-text-effect-918.html&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
