...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#FFF"
    ctx.fillText("MrTomXxX", canvas.width /  2 - 660, 1600);
    ctx.save();
    ctx.font = "350px Grandstander";
    ctx.fillStyle = "#000"
    ctx.fillText("TomBot", canvas.width / 2 - 660, 1000);
    ...
    ctx.fillStyle = "#FFF"
    ctx.fillText("MrTomXxX", 1600, 3150);
    ctx.fillStyle = "#000"
   ctx.fillText("MrTomXxX", 2000, 3600);
    ctx.beginPath();
