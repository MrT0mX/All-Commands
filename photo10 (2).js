...
}) =>
{
  ...
  {
    axios.get(`https://cakrayp.herokuapp.com/api/textmaker/textprome/create?text=${encodeURIComponent(juswa)}&url=https://textpro.me/break-wall-text-effect-871.html&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
