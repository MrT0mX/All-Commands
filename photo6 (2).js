...
}) =>
{
  ...
  {
    axios.get(`https://cakrayp.herokuapp.com/api/textmaker/textprome/create?text=${encodeURIComponent(juswa)}&url=https://textpro.me/bokeh-text-effect-876.html&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
