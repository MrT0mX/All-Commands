...
module.exports.run = async ({ api, event, args }) => {
   ...
   /* function generateRandomColor() {
    ...
    const color = args[3] || colorr;
            ...
            let getAvatar = (await axios.get(`https://api.phamvandien.xyz/taoanhdep/avatarwibu?id=${id}&chu_nen=${namebg}&chu_ky=${chuky}&mau_nen=${color}`, { responseType: "arraybuffer" } )).data; 
