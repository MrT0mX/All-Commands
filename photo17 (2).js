...
}) =>
{
  ...
  {
    axios.get(`https://cakrayp.herokuapp.com/api/textmaker/textprome/create?text=${encodeURIComponent(juswa)}&url=https://textpro.me/3d-stone-cracked-cool-text-effect-1029.html&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
