  ...
  switch (args[0]) {
    ...
    case "only": {
      ...
      if (config.adminOnly == false) {
        ...
        api.sendMessage(
          "» Successfully enabled admin only",
          threadID,
          messageID
        );
      } else {
        ...
        api.sendMessage(
          "» Successfully turned off admin only",
          threadID,
          messageID
        );
      }
    ...
    case "boxonly": {
      ...
      if (adminbox[threadID] == true) {
        ...
        api.sendMessage(
          "» Successfully turned off admin mode (everyone can use bots)",
          threadID,
          messageID
        );
      } else {
        ...
        api.sendMessage(
          "» Successfully enabled admin mode (only admin box can use bot)",
          threadID,
          messageID
        );
      }
